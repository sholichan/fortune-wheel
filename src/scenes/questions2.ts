...
export default class Questions2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.background = this.add.image(cam.width / 2 - 50, cam.height / 2, 'background2')
            .setScale(1.1, 1)

        //Question
        this.text = this.add.text(cam.width / 2, cam.height / 3, "Question", {
